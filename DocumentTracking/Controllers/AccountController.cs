...
namespace DocumentTracking.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            //ViewBag.Department = new SelectList(db.Departments.ToList(), "DeptId", "Description");
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                using (var db = new ApplicationDbContext())
                {
                    ...
                    users = await manager.FindByEmailAsync(model.Email);
                    users.isReset = false;
                    Task.WaitAny(manager.UpdateAsync(users));
                    Task.WaitAny(db.SaveChangesAsync());
                }
